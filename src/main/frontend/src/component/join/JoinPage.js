    ...
    <div className='agreePage'>
      ...
      <div className='agreeText'>
        ...
        <div className='agreeTextBox'>
          <div className='innerCase'>
            <div className='footerterms_wrap'>
              ...
              <ul>
                <li>
                울산메디칼센터 홈페이지 이용약관(이하 "본 약관"이라 합니다)은 이용자가 울산메디칼센터(이하 "병원"이라 합니다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 합니다)를 이용함에 있어 이용자와 "병원"의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
                </li>
              </ul>
              <h4>02. 제 2조 (정의)</h4>
              <ul>
        ...
        <div className='agreeText'>
          ...
          <div className='agreeTextBox'>
            <div className='innerCase'>
              <p>울산메디칼센터에서 개인정보를 수집하고 이용하는 목적은 홈페이지 회원의 가입 및 관리를 위함입니다. 수집한 개인정보를 다음의 목적을 위해 활용합니다.</p>
              <div className='box'>
                <ul>
                  <li>
                  ...
                  <li>
                  ⑤ 울산메디칼센터 모바일앱 서비스 제공을 위한 회원정보 연동
                  </li>
                </ul>
              </div>
              <p>
              ...
              <p>
              울산메디칼센터에서 수집하는 개인정보 항목은 다음과 같습니다.
              </p>
              <div className='box'>
                <dl>
                  <dt>[필수항목]</dt>
                ...
                <p>개인정보는 울산메디칼센터이 고객에게 서비스를 제공하는 기간에 한하여 보유 및 이용되며 회원 탈퇴시에는 즉시 파기합니다.</p>
                <ul className='box-ul'>
